...
CREATE TABLE candidat (
  ...
  id_statu_candidat INT , -- pour les validation
...
CREATE TABLE poste (
  ...
  id_personne int(11) DEFAULT NULL,            --Null pas de impute
  argument varchar(150) DEFAULT NULL,           --pas de impute 
  salaire decimal(10,2) DEFAULT NULL,             --pas de impute 
  disponible int(11) DEFAULT NULL,                  --pas de impute
  id_diplome_requis int(11) DEFAULT NULL,            -- liste deroulante  , je vais donner la table si dessou 
  id_degre_diplome_requis int(11) DEFAULT NULL,        --pas de impute
  age_requis int(11) DEFAULT NULL,                      --inpute
  id_genre_requis int(11) DEFAULT NULL,                  --inpute mais peut être null
  taille decimal(5,2) DEFAULT NULL,                       --pas  de inpute
  poids decimal(5,2) DEFAULT NULL,                          --pas  de inpute
  id_lieu_requis int(11) DEFAULT NULL,                       --pas  de inpute
  id_statu_poste int(11) DEFAULT NULL,                        -- dans controller mettre une valleur par defaut = 1 mais pas de impute dans view
